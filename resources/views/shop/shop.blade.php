                    ...
                    <form id="price-filter-form">
                        ...
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <input type="checkbox" class="custom-control-input" id="price-all"
                                {{ request()->has('min_price') && request()->filled('min_price') ? '' : 'checked' }}>
                            ...
                            <div class="card product-item border-0 mb-4">
                                <div
                                    ...
                                    <img class="img-fluid w-100"
                                        style="height:15rem"src="{{ config('app.base_url') . $product['feature_image_path'] }}"
                                        alt="">
                                </div>
                                ...
                                <div class="card-footer d-flex justify-content-between bg-light border">
                                    <a href="{{ route('detail.index', ['id' => $product['id']]) }}"
                                        ...
                                        Detail</a>
                                    <span data-url="{{ route('cart.add', ['id' => $product['id']]) }}"
